<template>
  <footer class="flex justify-center my-4 text-sm">
    <a class="" target="_blank" rel="nofollow noopener noreferrer" href="/feed.xml">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
        width="13"
        height="13"
        class="text-gray-600 fill-current stroke-current hover:text-blue-400 align-middle"
      >
    ...
    <a class="ml-5" target="_blank" rel="nofollow noopener noreferrer" href="https://twitter.com/willbrowningme">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
        width="13"
        height="13"
        class="text-gray-600 fill-current hover:text-blue-400 align-middle"
      >
    ...
    <a class="ml-5" target="_blank" rel="nofollow noopener noreferrer" href="https://github.com/willbrowningme">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
        width="13"
