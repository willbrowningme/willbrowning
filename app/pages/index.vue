<template>
  <section class="my-8">
    <div class="page-content page text-center md:text-left">
      ...
      <p>
        I have previously written about Laravel, Vue, Nuxt and related tools. Those posts are on the
        <a href="/writings">Writings</a> page.
      </p>
      <p>
        You can sign up for my <a href="/newsletter">Newsletter</a> or follow me on <a target="_blank" rel="nofollow noopener noreferrer" href="https://x.com/willbrowningme">X.com</a>.
      </p>
      <p>
        To email me, <EmailLink />.
      </p>
    </div>
  </section>
</template>
